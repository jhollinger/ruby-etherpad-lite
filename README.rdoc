...
*NOTE* Support for Ruby 1.8.x is deprecated and will be removed in future versions. Upgrade to Ruby 1.9.x and stop being an old fuddie-duddie.
...
- A high-level "models" interface (above)
- A low-level client matching the HTTP API (below)
