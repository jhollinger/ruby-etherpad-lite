...
or you can explicitly load just the low-level client:
    ...
    => {:text => "lots of new text and stuff"}

For a full list of methods and parameters, see {github.com/Pita/etherpad-lite/wiki/HTTP-API}[https://github.com/Pita/etherpad-lite/wiki/HTTP-API].
